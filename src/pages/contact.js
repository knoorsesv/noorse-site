      ...
      <div className="tile is-parent">
        ...
        <noorse-section class="tile is-child" header="Kantine">
          ...
          <p>
            ...
            Vrijdag 18u00 – 23u00<br/>

            Zaterdag en zondag wordt de kantine geopend een uur voor aanvang van de eerste wedstrijd. Dit zal meestal om
            8u00 s ochtends zijn en sluit 2,5 na afloop van de laatste wedstrijd.<br/>
            Wil je checken of kantine open is? Check even via socceronline of bel naar onze kantine.<br/>
            Tel: 03 664 44 12 <br/>
        ...
        <noorse-section class="tile is-child" header="Bereikbaarheid">
          ...
          <p> Frans De Peuterstraat, Kapellen. A12 Haven – Bergen op Zoom blijven volgen tot afrit Hoevenen / Kapellen.
            2e </p>
          <p> straat rechts aan Texaco Station (Klein Heiken) inslaan daarna 5e straat links (Heizoomlaan) deze geeft
            uit
            op </p>
          <p> de terreinen.</p>
        </noorse-section>
